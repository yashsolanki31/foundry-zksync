...
mod tests {
    ...
    pub fn test_artifacts_extraction() {
        let data = include_str!("../../../../testdata/artifacts-counter/artifacts.json").as_bytes().to_vec();
        let mut displayed_warnings = HashSet::new();
    ...
    pub fn test_json_parsing() {
        ...
        let almost_empty_data = include_str!("../../../../testdata/artifacts-counter/empty.json").as_bytes().to_vec();
